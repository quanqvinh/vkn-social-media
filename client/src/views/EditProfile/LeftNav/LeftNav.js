...
const LeftNav = ({ handelSetChildForm }) => {
    ...
    return (
        <ul className="body__left-options">
            <NavLink exact to={`/profile/${id}/edit`} activeClassName="body__left-options--active">
            ...
            <NavLink
                ...
                <li className="body__left-options-change-password">Change Password</li>
            </NavLink>
            <NavLink to={`/profile/${id}/edit/email`} activeClassName="body__left-options--active">
